...
const App = () => {
  ...
  const lyricsData = [
    ...
    { time: 39, text: "ومش بقدر احس بحبهم مهما قالو بيحبوني" },
  ...
  useEffect(() => {
    if (step >= 0) glowSfxRef.current.play().catch(() => {});
    if (step === 14) setSkipCount(0); // تصفير عداد المقلب
  }, [step]);
  ...
  const handlePrankSound = () => {
    prankAudioRef.current.volume = 1.0;
    ...
    >
      ...
      <AnimatePresence mode="wait">
        ...
        >
          {step === -1 && (
            <div>
              <ShieldCheck size={50} style={{ marginBottom: "20px" }} />
          ...
          {step === 1 && (
            <div>
              <Skull size={60} style={{ marginBottom: "20px" }} />
          ...
          {/* STEP 2: إضافة سؤال سوريا الجديد */}
          {step === 2 && (
            <div>
              <MapPin
                size={60}
          ...
          {step === 5 && (
            <div>
              <MessageSquare size={50} style={{ marginBottom: "20px" }} />
          ...
          {step === 6 && (
            <div>
              <UserX size={50} style={{ marginBottom: "20px" }} />
                ...
                <AnimatePresence mode="wait">
                  {videoTime >= 26 && videoTime < 39 && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, y: 0, textShadow: "0 0 8px #fff" }}
                      exit={{ opacity: 0 }}
                      style={{
                        padding: "15px",
                        background: "rgba(255,255,255,0.05)",
                  ...
                  {videoTime >= 40 && videoTime < 45 && (
                    ...
                    >
                      ...
                      عن شباب كتير ودا اللي هيحببها بأدهم يعني عيوبك انت تتقارن
                      بأحسن مميزات بالنسبة لفئة شباب دي
                    </motion.div>
                  )}
                  {videoTime >= 46 && videoTime < 48 && (
                    <motion.div
                      key="m3"
                      initial={{ opacity: 0, y: 10 }}
                      animate={{ opacity: 1, y: 0, textShadow: "0 0 8px #fff" }}
                    ...
                    >
                      <strong>بيجاد بيقول:</strong> ما رضيتش أرد بمثله عشان
                      إتربّيت والله .. وانا اكتر حد شوفت ادهم رغم تقصيره بحاجات
                      كتير بس عمره ما قل من حد عشان "فلوس" او "صحبة" او "مصلحة"
                    </motion.div>
                  )}
                  {videoTime >= 49 && videoTime < 55 && (
                    <motion.div
                      key="m4"
                      initial={{ opacity: 0, y: 10 }}
                      animate={{ opacity: 1, y: 0, textShadow: "0 0 8px #fff" }}
                    ...
                    >
                      <strong>بيجاد بيقول:</strong> بتسكتروها عليا ليه؟ ما أنا
                      شقيت والله .. وربنا يشهد كنت لما تسند حد بتبقى حرفيا في
                      ضهره رغم انه ممكن يكون فمرة دايقك بطريقة وحشة لكن رغم دا
                      بتعدي وعايزك دايما كدا ومتتغيرش في الحتة دي
                    </motion.div>
                  )}
                  {videoTime >= 56 && (
